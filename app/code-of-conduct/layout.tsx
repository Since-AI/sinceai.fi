...
export const metadata: Metadata = {
  ...
  description:
    "Since AI Code of Conduct: Our commitment to a safe, inclusive, and welcoming environment for all 500+ community members. Standards for hackathons, Discord, and all community spaces in Turku and beyond.",
  keywords: [
